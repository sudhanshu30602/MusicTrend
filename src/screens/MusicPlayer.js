...
const MusicPlayer = () => {
  ...
  const [heart, setHeart] = useState('off');
    ...
    <SafeAreaView style={style.container}>
      ...
      <View style={style.bottomSection}>
        <View style={style.bottomIconContainer}>
          <TouchableOpacity
            onPress={() => {
              {heart == 'off' ? setHeart('on') : setHeart('off')}
            }}>
            <Ionicons
              name="heart-outline"
              size={30}
              color={heart !== 'off' ? 'red' : '#888888'}
            />
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {}}>
            <Ionicons name="share-outline" size={30} color="green" />
          </TouchableOpacity>

          <TouchableOpacity onPress={() => {}}>
            <Ionicons name="ellipsis-horizontal" size={30} color="blue" />
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
